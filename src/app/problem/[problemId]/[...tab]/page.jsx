...
import ProblemContent from "@/app/problem/[problemId]/[...tab]/ProblemContent";
...
export default async function ProblemPage({params}) {
  ...
  return (
    <ProblemContent initCode={codeMapping} problemDetail={problemDetail?.problemDetail} title={problemDetail?.title}></ProblemContent>
  )
}
